  ...
  return (
    <div className={styles.component}>
      ...
      <div className={classes.root}>
        ...
        <FormControl variant="outlined" className={classes.formControl}>
          <InputLabel id="demo-simple-select-outlined-label">Starters</InputLabel>
          <Select
            labelId="demo-simple-select-outlined-label"
            id="demo-simple-select-outlined"
            value={state.starters}
            onChange={handleChange}
            label="Starters"
          >
            <MenuItem value={14}>None</MenuItem>
            <MenuItem value={15}>Water</MenuItem>
            <MenuItem value={16}>Bread</MenuItem>
          </Select>
        </FormControl>
      </div>
